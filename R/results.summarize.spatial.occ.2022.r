...
#adjust for plotting purpose

index=which(states.mcmc2.prob$State=="Utah" & states.mcmc2.prob$mcmc>0.01)
states.mcmc2.prob$mcmc[index]=0.01

index=which(states.mcmc2.prob$State=="Colorado" & states.mcmc2.prob$mcmc>0.01)
states.mcmc2.prob$mcmc[index]=0.01

index=which(states.mcmc2.prob$State=="Oregon" & states.mcmc2.prob$mcmc>0.01)
states.mcmc2.prob$mcmc[index]=0.01
